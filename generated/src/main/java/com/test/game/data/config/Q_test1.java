...
/** Created by FreeMarker. DO NOT EDIT!!! 测试表1 */
  ...
  public static class Builder {
    ...
    protected Builder(ByteBuf buf) {
      try {
        ...
        throw new com.test.game.core.exception.ConfigFieldException(e.getMessage(), "q_id", e);
      }
      try {
        this.q_name = ByteBufUtils.readString(buf);
      } catch (Throwable e) {
        throw new com.test.game.core.exception.ConfigFieldException(e.getMessage(), "q_name", e);
      }
      try {
        this.q_sss = ByteBufUtils.readBoolean(buf);
      } catch (Throwable e) {
        throw new com.test.game.core.exception.ConfigFieldException(e.getMessage(), "q_sss", e);
      }
    }
  }
