...
public class MsgSrcGen {
    ...
    private static final String target_pkg = "com.test.game.data.message";
    ...
    public static void main(String[] args) throws Exception {
        GenerateUtils.genMsgSrc(
                pkg,target_pkg,id_file, server_src_dir, server_custom_src_dir, client_src_dir, client_custom_src_dir);
    }
}
